...
{%- set api_domain = "gov-nhncloudservice.com" if "gov" in build_flags else "nhncloudservice.com" %}
...
| workloads.autoScaler.scaleOut.condition.resource | Body | String | X | 증설 조건 기준 리소스<ul><li>cpu</li><li>memory</li>{% if "gov" not in build_flags %}<li>gpu</li><li>gpu-memory</li></ul>{% else %}</ul>{% endif %} |
...
| workloads.autoScaler.scaleIn.condition.resource | Body | String | X | 감축 조건 기준 리소스<ul><li>cpu</li><li>memory</li>{% if "gov" not in build_flags %}<li>gpu</li><li>gpu-memory</li></ul>{% else %}</ul>{% endif %} |
...
| workload.autoScaler.scaleOut.condition.resource | Body | String | X | 증설 조건 기준 리소스<ul><li>cpu</li><li>memory</li>{% if "gov" not in build_flags %}<li>gpu</li><li>gpu-memory</li></ul>{% else %}</ul>{% endif %} |
...
| workload.autoScaler.scaleIn.condition.resource | Body | String | X | 감축 조건 기준 리소스<ul><li>cpu</li><li>memory</li>{% if "gov" not in build_flags %}<li>gpu</li><li>gpu-memory</li></ul>{% else %}</ul>{% endif %} |
