...
* If you do not assign a load balancer IP, the IP may change if the load balancer is recreated.
* If you assign a load balancer IP, that IP is retained even if the load balancer is recreated. The assigned IP is retained until you explicitly change it or delete the workload.
