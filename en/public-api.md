...
| templates.containers.sharedMemory.changed | Body | Boolean | O | Whether the container shared memory settings have changed<ul><li>true: Changed</li><li>false: Not changed</li></ul> |
...
| template.containers.sharedMemory | Body | Object | X | Information on container shared memory settings |
...
| template.containers.sharedMemory.sizeLimit | Body | Boolean | O | Shared memory (MiB) configured for the container |
...
| templates.containers.stopTimeout | Body | Integer | X | Initialization container execution timeout (seconds) |
| templates.containers.sharedMemory | Body | Object | X | Information on container shared memory settings |
...
| workloads.loadBalancing.vipAddress | Body | String | X | Specify internal load balancer IP |
...
| workload.tasks.containers.sharedMemory.changed | Body | Boolean | O | Whether the container shared memory settings changed<ul><li>true: Changed</li><li>false: Not changed</li></ul> |
| workload.tasks.containers.sharedMemory.sizeLimit | Body | Boolean | O | Shared memory configured for the container (MiB) |
