...
| templates.containers.sharedMemory.changed | Body | Boolean | O | コンテナ共有メモリ設定の変更有無<ul><li>true: 変更</li><li>false: 変更しない</li></ul> |
...
| template.containers.sharedMemory | Body | Object | X | コンテナ共有メモリ設定情報 |
| template.containers.sharedMemory.changed | Body | Boolean | O | コンテナの共有メモリ設定の変更有無<ul><li>true: 変更</li><li>false: 変更なし</li></ul> |
| template.containers.sharedMemory.sizeLimit | Body | Boolean | O | コンテナに設定する共有メモリ (MiB) |
...
| workloads.loadBalancing.ipAddress | Body | String | O | ワークロードロードバランサーのIP情報(vip, floating ip) |
